  ...
  : describe("SmartLottery", function () {
      ...
      describe("enterLottery", function () {
        ...
        it("Should revert if player already inside lottery", async function () {
          ...
          ).to.be.revertedWith("Player already in lottery");
        });
      ...
      describe("rawFillRandomWords", function () {
        beforeEach(async function () {
          const txEnter = await smartLottery.enterLottery({
            value: lotteryEntranceFee,
          });
        ...
        it("Should only be called by coordinator", async function () {
          await expect(
            smartLottery.rawFulfillRandomWords(0, [77])
